...
class Conference(models.Model):
    ...
    class Meta:
        ordering = ['-start_date'] # Сортировка: свежие сверху
...
class Participation(models.Model):
    ...
    # Флаг для админа: рекомендован к публикации
    is_recommended = models.BooleanField("Рекомендован к публикации", default=False)

    class Meta:
        unique_together = ('user', 'conference') # Один юзер - одна заявка на конкретную конфу
