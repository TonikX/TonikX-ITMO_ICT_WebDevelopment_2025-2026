...
1. [Обзор архитектуры фронтенда](#обзор-архитектуры-фронтенда)
2. [Технологический стек](#технологический-стек)
3. [Установка и настройка проекта](#установка-и-настройка-проекта)
4. [Структура проекта фронтенда](#структура-проекта-фронтенда)
5. [Настройка маршрутизации (Vue Router)](#настройка-маршрутизации-vue-router)
6. [Управление состоянием (Vuex/Store)](#управление-состоянием-vuexstore)
7. [Аутентификация и авторизация](#аутентификация-и-авторизация)
8. [Ключевые компоненты фронтенда](#ключевые-компоненты-фронтенда)
9. [Интеграция с бэкендом (API)](#интеграция-с-бэкендом-api)
