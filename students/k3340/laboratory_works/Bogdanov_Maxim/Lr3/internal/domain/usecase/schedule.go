...
// ScheduleUseCase интерфейс для бизнес-логики работы с расписанием
type ScheduleUseCase interface {
	// Create создает новую запись расписания
	Create(ctx context.Context, classID, weekdayID, lessonNumber, subjectID, teacherID, classroomID int) (*domain.Schedule, error)
	...
	Update(ctx context.Context, id int, classID, weekdayID, lessonNumber, subjectID, teacherID, classroomID int) (*domain.Schedule, error)
