...
### 1. Интерфейс авторизации (`LoginView.vue`)
...
### 2. Интерфейс регистрации (`RegisterView.vue`)
...
### 3. Интерфейс привязки читательского билета (`LinkReaderView.vue`)
...
### 4. Интерфейс профиля читателя (`ProfileView.vue`)
...
### 5. Интерфейсы администратора

#### 5.1 Панель администратора (`AdminDashboard.vue`)
...
#### 5.2 Управление читателями (`AdminReaders.vue`)
...
#### 5.3 Регистрация читателя (`AdminReaderRegister.vue`)
...
#### 5.4 Управление книгами (`AdminBooks.vue`)
...
#### 5.5 Добавление книги (`AdminBookAdd.vue`)
...
#### 5.6 Добавление экземпляров к книге (`AdminBookAddCopies.vue`)
...
#### 5.7 Списание экземпляра (`AdminBookDecommission.vue`)
...
#### 5.8 Перемещение экземпляра (`AdminCopyTransfer.vue`)
...
#### 5.9 Выдача книги (`AdminIssueBookView.vue`)
...
#### 5.10 Книги на руках (`AdminOnLoanView.vue`)
...
#### 5.11 Управление выдачами (`AdminManageLoansView.vue`)
...
### 6. Публичный каталог книг (`BooksView.vue`)
...
В ходе лабораторной работы был реализован полнофункциональный клиент для библиотечной системы.
