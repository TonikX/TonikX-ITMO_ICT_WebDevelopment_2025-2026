"""
Django settings for racetab project.
...
SECRET_KEY = 'django-insecure-x2od)z@(u604$^g6r=i27#=*%(5w#r2pob7qu@_qje3kt9k1p0'
...
WSGI_APPLICATION = 'racetab.wsgi.application'
