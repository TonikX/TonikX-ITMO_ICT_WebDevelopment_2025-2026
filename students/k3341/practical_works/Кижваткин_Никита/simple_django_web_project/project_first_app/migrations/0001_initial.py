    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passport', models.CharField(blank=True, help_text='В формате: XX XX XXXXXX', max_length=20, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Номер паспорта должен быть в формате: XX XX XXXXXX', regex='^\\d{2} \\d{2} \\d{6}$')], verbose_name='Номер паспорта')),
                ('home_address', models.TextField(blank=True, help_text='Адрес проживания', max_length=500, null=True, verbose_name='Адрес проживания')),
        ...
        migrations.AddField(
            model_name='owner',
            name='cars',
            field=models.ManyToManyField(through='project_first_app.Ownership', to='project_first_app.car', verbose_name='Автомобили'),
        ),
    ]
