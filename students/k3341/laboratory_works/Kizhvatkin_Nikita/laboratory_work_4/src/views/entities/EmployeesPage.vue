...
const { items, loading, error, list, create, update, remove } = useCrudResource(endpoints.employees)
...
async function bootstrap() {
  ...
  const positionItems = [
    { title: 'Командир', value: 'captain' },
    { title: 'Второй пилот', value: 'copilot' },
    { title: 'Штурман', value: 'navigator' },
    { title: 'Стюард/Стюардесса', value: 'steward' },
  ]
