# Практические работы по Django REST Framework

## Файлы выполнения практических работ 1 и 2 можно найти в репозитории:

`students/k3341/pracrical_works/Smirnova_Karina/simple_drf_project`
