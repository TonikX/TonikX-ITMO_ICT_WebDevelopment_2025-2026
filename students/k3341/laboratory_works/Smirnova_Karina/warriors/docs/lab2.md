...
Вот такой вид имеет страница резервирований:
![Страница резервирований](admin_reservation.jpg)
...
![Страница тура для пользователя](user_tour_detail.jpg)

И такой вид для администратора:
![Страница тура для админа](admin_tour_detail.jpg)


### 5. Формирование личной страницы пользователя (users app)

Для создания страницы по требованиям задания на страницу была добавлена таблица со всеми зарезервированными турами. Для
этого был переписан шаблон html и представление было обновлено до такого:
...
Вот такой внешний вид имеет страница профиля:

![Страница профиля](profile.jpg)