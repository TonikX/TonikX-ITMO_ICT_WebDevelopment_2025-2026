...
SECRET_KEY = "django-insecure-e82yk8%d3+=e+f86(%%gk4__ldb#$vk97p_nd63aqucu_t+r-1"
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.BasicAuthentication',   # для basic auth
    ],
}

# настройки djoser для работы с username и повтором пароля
DJOSER = {
