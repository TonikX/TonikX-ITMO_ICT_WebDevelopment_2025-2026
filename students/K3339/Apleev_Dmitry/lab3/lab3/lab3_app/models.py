...
#     max_length=100,           # Максимальная длина (для CharField)
#     verbose_name="Имя",        # Человеко-понятное название
#     null=True,                 # Можно хранить NULL в базе
#     blank=True,                # Можно оставить пустым в формах
#     default="значение",         # Значение по умолчанию
#     unique=True,               # Значение должно быть уникальным
#     primary_key=True,          # Сделать первичным ключом
#     editable=True,             # Можно редактировать (по умолчанию True)
#     help_text="Подсказка",      # Текст-подсказка
#     choices=CHOICES,           # Выбор из списка
# )
...
class Client(models.Model):
    ...
    # кто оформил бронь (пользователь сайта)
