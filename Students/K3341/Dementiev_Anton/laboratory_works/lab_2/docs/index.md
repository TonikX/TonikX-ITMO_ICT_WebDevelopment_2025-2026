...
- Освоить основы разработки веб-приложений на Django.
- Научиться проектировать модели данных и настраивать админ-панель.
- Отработать работу с шаблонами, формами и маршрутизацией.
...
_Документация создана с помощью [MkDocs](https://www.mkdocs.org/) и [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/)_
