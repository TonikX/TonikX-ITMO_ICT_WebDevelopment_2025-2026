...
Добро пожаловать на страницу с отчетами по лабораторным работам по курсу "Web-программирование"!
...
_Все отчеты созданы с помощью [MkDocs](https://www.mkdocs.org/) и [Material for MkDocs](https://squidfunk.github.io/mkdocs-material/)_
