# Generated by Django 5.2.7 on 2025-12-26 19:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.IntegerField(blank=True, null=True, verbose_name='Уровень освоения умения')),
        ...
        migrations.AddField(
            ...
            name='warrior',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='warrior_skills', to='warriors_app.warrior', verbose_name='Воин'),
        ),
    ]
