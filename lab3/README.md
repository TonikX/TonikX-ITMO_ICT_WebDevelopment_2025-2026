# Лабораторная работа №3: Система для проведения хакатонов
...
Полная документация доступна в папке `docs/` или после запуска MkDocs.
...
Подробнее о правах доступа в [документации](docs/docs/roles.md).
...
Больше примеров в [документации](docs/docs/examples.md).
