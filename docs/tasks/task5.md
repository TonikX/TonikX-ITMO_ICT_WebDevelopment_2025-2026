...
- **HTTP методы** - GET для получения данных, POST для создания
- **Парсинг HTTP** - разбор заголовков и тела запроса
- **Валидация данных** - проверка входных параметров
- **HTML генерация** - динамическое создание веб-страниц
- **Обработка ошибок** - HTTP коды состояния

## Особенности реализации

- **Простой HTTP парсер** - разбор GET и POST запросов
- **Валидация данных** - проверка оценок от 1 до 5
- **Хранение в памяти** - простое решение без базы данных
- **HTML интерфейс** - удобный веб-интерфейс
...
Задание 5 демонстрирует современные подходы к веб-разработке:
- HTTP методы обеспечивают RESTful архитектуру
- Валидация данных критична для безопасности
- HTML интерфейс создает удобный пользовательский опыт
- Простая реализация помогает понять основы веб-серверов