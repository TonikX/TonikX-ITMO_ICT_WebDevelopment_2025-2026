...
### Так как используется `ModelViewSet`, то PUT|PATCH|DELETE|GET Обрабатываются на эндпоинте **api/rooms/{id}/** 
...
### Так как используется `ModelViewSet`, то PUT|PATCH|DELETE|GET Обрабатываются на эндпоинте **api/clients/{id}/** 
