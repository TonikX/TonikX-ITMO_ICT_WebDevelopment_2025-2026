...
- **Моделей**: 4 (Warrior, Profession, Skill, SkillOfWarrior)
- **Сериализаторов**: 8 различных типов
- **API endpoints**: 12 endpoints
- **Тестовых данных**: 5 воинов, 5 профессий, 18 навыков
...
Проект полностью готов к демонстрации и включает:
- Рабочий API с полным CRUD функционалом
